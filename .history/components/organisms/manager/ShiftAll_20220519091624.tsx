      ...
      {loading == true ? (
        ...
        <>
          <Box ml={3}>
            ...
            <Box>
              <IconButton
                onClick={() =>
                  !user
                    ? router.push(`/${query.id}/staffs`)
                    : router.push(`/${user_query.companyId}/staffs`)
                }
              >
            ...
            <DateRangePicker
              ...
              changeDate={(newValue) =>
                !user
                  ? loadFreeSpace_newValue(chgDate(newValue), query.id)
          ...
          <SelectTeacherModal
            ...
            queryId={!user ? query.id : user_query?.companyId}
          />
        </>
      )}
    </React.Fragment>
